...
//antiprivado.js
smsprivado: (m, cuentas) => `*@${m.sender.split`@`[0]} Esta prohibido escribir al privado*\n\n> *Únete a la comunidad 〘Noⷦvͣaͥ-Liⷦoͤnͯ'sͭ〙 para conocer cómo puedes tener tú propio Bot para WhatsApp*\n${cuentas}\n\n⚠️ \`\`\`Serás Bloqueado(a)\`\`\` ⚠️`, 
...
//grupos
smsAdd: 'Hola! me presento, soy 〘Noⷦvͣaͥ-Liⷦoͤnͯ'sͭ〙👻🦁, soy un Bot de WhatsApp, una persona del grupo utilizo el comando para añadirte al grupo, pero no pude agregarte, asi que te mando la invitacion para que te unas al grupo, te esperamos con ansias!!', 
